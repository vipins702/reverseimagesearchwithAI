...
import { Search, Upload, Zap, Shield, CheckCircle, ArrowRight, Eye, Clock, Globe, Image as ImageIcon } from 'lucide-react'
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Find Duplicate Photos & Reverse Image Search | DuplicateDetective</title>
        <meta name="description" content="Free tool to find duplicate photos, check if an image is stolen, and identify fake profiles. Search across Google Lens, Bing, Yandex & TinEye instantly." />
        <meta name="keywords" content="find duplicate photos for free, check if image is stolen, instagram image source finder, upload image to find source, identify fake profiles, reverse image search, duplicate image finder" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Find Duplicate Photos & Check Image Sources Free" />
        <meta property="og:description" content="Instantly find duplicate images, verify profiles, and track image theft. 100% Free multi-engine reverse image search." />
        ...
        <meta name="twitter:title" content="Find Duplicate Photos & Check Image Sources Free" />
        <meta name="twitter:description" content="Instantly find duplicate images, verify profiles, and track image theft. 100% Free multi-engine reverse image search." />
          ...
          {`
            {
              ...
              "description": "Free reverse image search tool to find duplicate photos, verify image sources, and detect copyright infringement.",
              "aggregateRating": {
            ...
            >
              ...
              <div className="space-y-6">
                <motion.h1
                  ...
                  className="text-3xl md:text-5xl font-bold heading-premium gradient-text-cosmic leading-tight mt-4"
                >
              ...
              >
                <span className="flex items-center gap-3 glass px-4 py-2 rounded-full">
                  ...
                  <span className="text-gray-200">100% Free Forever</span>
                </span>
                <span className="flex items-center gap-3 glass px-4 py-2 rounded-full">
                  <CheckCircle className="w-5 h-5 text-blue-400" />
                  <span className="text-gray-200">No Registration</span>
                </span>
                <span className="flex items-center gap-3 glass px-4 py-2 rounded-full">
                  <CheckCircle className="w-5 h-5 text-purple-400" />
                  <span className="text-gray-200">Multi-Engine Search</span>
                </span>
                <span className="flex items-center gap-3 glass px-4 py-2 rounded-full">
              ...
              {/* Premium Glassmorphic Upload Card - Replaced with Functional HomeUpload */}
              <motion.div
          ...
          >
            ...
            <div className="glass-strong rounded-3xl p-8 md:p-12 space-y-8">
              <div className="prose prose-lg max-w-none">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">The Technology Behind Reverse Image Search</h3>
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Multi-Engine Search for Comprehensive Results</h3>
                <p className="text-gray-300 leading-relaxed mb-6">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">The Search Process Explained</h3>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              ...
              >
                <div className="relative mb-6 group">
                  <div className="glass-strong rounded-2xl p-6 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-white/10">
                    <div className="w-full h-48 bg-gradient-to-br from-blue-500/20 to-blue-600/20 rounded-xl flex items-center justify-center mb-4">
                      <Upload className="w-20 h-20 text-blue-400" />
                    </div>
                    <div className="absolute -top-4 -left-4 w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-2xl flex items-center justify-center font-bold text-2xl shadow-lg border border-white/20">
                      1
                    </div>
                  </div>
                </div>
                <h3 className="text-xl font-bold mb-3 text-white">Upload Your Image</h3>
              ...
              >
                <div className="relative mb-6 group">
                  <div className="glass-strong rounded-2xl p-6 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-white/10">
                    <div className="w-full h-48 bg-gradient-to-br from-purple-500/20 to-purple-600/20 rounded-xl flex items-center justify-center mb-4">
                      <Zap className="w-20 h-20 text-purple-400" />
                    </div>
                    <div className="absolute -top-4 -left-4 w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-2xl flex items-center justify-center font-bold text-2xl shadow-lg border border-white/20">
                      2
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="relative mb-6 group">
                  <div className="glass-strong rounded-2xl p-6 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-white/10">
                    <div className="w-full h-48 bg-gradient-to-br from-green-500/20 to-green-600/20 rounded-xl flex items-center justify-center mb-4">
                      <Search className="w-20 h-20 text-green-400" />
                    </div>
                    <div className="absolute -top-4 -left-4 w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 text-white rounded-2xl flex items-center justify-center font-bold text-2xl shadow-lg border border-white/20">
                      3
                    </div>
                  </div>
                </div>
                <h3 className="text-xl font-bold mb-3 text-white">Get Instant Results</h3>
                <p className="text-gray-400 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-white mb-1">Track Copyright Infringement</h4>
                        <p className="text-gray-400">Find unauthorized use of your photos, artwork, and designs across the web</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-blue-400 mt-1 flex-shrink-0" />
                      <div>
                        <h4 className="font-semibold text-white mb-1">Monitor Image Usage</h4>
                        <p className="text-gray-400">Regular reverse image searches help photographers and artists protect their intellectual property</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-purple-400 mt-1 flex-shrink-0" />
                      <div>
                        <h4 className="font-semibold text-white mb-1">Find Original Sources</h4>
                        <p className="text-gray-400">Identify where images first appeared and track their distribution online</p>
                      </div>
                    </div>
                  </div>
                  <Link
                ...
                <div className="relative">
                  <OptimizedImage
                    ...
                    loading="lazy"
                  />
                  <div className="absolute -bottom-4 -right-4 bg-slate-800 rounded-xl shadow-xl px-4 py-2 border border-white/10">
                    <p className="text-sm font-semibold text-white">✓ Track 1000+ Images Monthly</p>
                  </div>
                </div>
              </div>
            </motion.div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl md:text-2xl font-bold mb-3 text-white group-hover:text-purple-400 transition-colors">
                        {feature.title}
                      </h3>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <motion.div
                ...
                transition={{ duration: 0.6, delay: 0.1 }}
                viewport={{ once: true }}
                className="glass-strong p-8 rounded-2xl hover-lift border border-white/10"
              >
                <div className="text-5xl mb-6">📸</div>
                <h3 className="text-2xl font-bold mb-4 text-white">Copyright Protection & Image Tracking</h3>
              ...
              >
                <div className="text-5xl mb-6">🛒</div>
                <h3 className="text-2xl font-bold mb-4 text-white">Product Research & Shopping</h3>
                <p className="text-gray-300 leading-relaxed mb-4">
              ...
              >
                <div className="text-5xl mb-6">✅</div>
                <h3 className="text-2xl font-bold mb-4 text-white">Image Verification & Fact-Checking</h3>
                <p className="text-gray-300 leading-relaxed mb-4">
      ...
      < section className="py-20 relative" >
        <div className="absolute inset-0 bg-gradient-to-t from-transparent via-purple-900/10 to-transparent pointer-events-none" />
        <div className="container mx-auto px-4 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-3 text-white">Multi-Engine Search Power</h3>
                <p className="text-gray-400 leading-relaxed">
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-3 text-white">100% Free Forever</h3>
                <p className="text-gray-400 leading-relaxed">
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-3 text-white">No Registration Required</h3>
                <p className="text-gray-400 leading-relaxed">
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-3 text-white">Support for All Image Formats</h3>
                <p className="text-gray-400 leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-6xl mx-auto">
            <Link
              ...
              className="group glass-strong rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 flex flex-col md:flex-row border border-white/10"
            >
              <div className="md:w-2/5 bg-gradient-to-br from-blue-900/40 to-purple-900/40 p-12 flex items-center justify-center">
